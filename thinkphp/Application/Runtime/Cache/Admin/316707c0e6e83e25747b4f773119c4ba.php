...
<div class="panel admin-panel">
  ...
  <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="/thinkphp/index.php/Admin/Class/class_add"> 添加分类</a> </li>
        <li>
      ...
      <volist name="list" id="vo">
      	<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
              <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="id[]" value="<?php echo ($v["id"]); ?>" />
               <?php echo ($v["id"]); ?></td>
              <td><?php echo ($v["fatherid"]); ?></td>
              <td><?php echo ($v["classname"]); ?></td>
              <td><?php echo ($v["addtime"]); ?></td>
              <td><font color="#00CC99"><?php echo ($v["adduser"]); ?></font></td>
              <td><div class="button-group"> <a class="button border-main" href="/thinkphp/index.php/Admin/Class/class_update/id/<?php echo ($v["id"]); ?>"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="/thinkphp/index.php/Admin/Class/class_del/id/<?php echo ($v["id"]); ?>"><span class="icon-trash-o"></span> 删除</a> </div></td>
            </tr><?php endforeach; endif; ?>
      <tr>
        <td style="text-align:left; padding:19px 0;padding-left:20px;"><input type="checkbox" id="checkall"/>
          全选 </td>
        <td colspan="8" style="text-align:left;padding-left:20px;"><a href="javascript:void(0)" class="button border-red icon-trash-o" style="padding:5px 15px;" onclick="DelSelect()">批量删除</a></td>
      </tr>
      <tr>
