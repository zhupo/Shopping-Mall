  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="/index.php/Admin/Admin/admin_add"> 添加管理员</a> </li>
        <li>
    ...
    <table class="table table-hover text-center">
      ...
      <volist name="list" id="vo">
      	<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
              ...
              <td width="10%"><?php echo ($v["sex"]); ?></td>
              <td><?php echo ($v["phone"]); ?></td>
              <td><font color="#00CC99"><?php echo ($v["addtime"]); ?></font></td>
              <td><div class="button-group"> <a class="button border-main" href="/index.php/Admin/Admin/admin_update/id/<?php echo ($v["id"]); ?>"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="/index.php/Admin/Admin/admin_del/id/<?php echo ($v["id"]); ?>"><span class="icon-trash-o"></span> 删除</a></div></td>
            </tr><?php endforeach; endif; ?>
      <tr>
        <td style="text-align:left; padding:19px 0;padding-left:20px;"><input type="checkbox" id="checkall"/>
          全选 </td>
        <td colspan="8" style="text-align:left;padding-left:20px;">
        <a href="/index.php/Admin/Admin/admin_delmore" class="button border-red icon-trash-o" style="padding:5px 15px;" >批量删除</a></td>
      </tr>
      <tr>
