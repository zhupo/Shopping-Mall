...
<div class="admin">
  ...
  <div class="padding border-bottom">
    <a href="/thinkphp/index.php/Admin/Product/product_list">
    <button type="button" class="button border-yellow"><span></span>返回列表</button></a>
  </div>
  <div class="body-content">
    <form method="post" class="form-x" action="" enctype="multipart/form-data">  
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo ($data['title']); ?>" name="title" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <select name="classId" class="input w50">
            <?php if(is_array($arr)): foreach($arr as $key=>$v): ?><neq name="v.id" value="$data.classid">
  				<option value="<?php echo ($v["id"]); ?>" <?php if(($v["id"]) == $data["classid"]): ?>selected<?php endif; ?> ><?php echo ($v["classname"]); ?></option>	    	
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="file" id="url1" name="thumb" value="<?php echo ($data['thumb']); ?>" class="input tips" style="width:25%; float:left;"  data-toggle="hover"  />
        </div>
      </div>     
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo ($data['specification']); ?>" name="specification" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo ($data['price']); ?>" name="price" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo ($data['stocks']); ?>" name="stocks" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        <div class="label">
      	...
      	<div class="field" style="padding-top:8px;"> 
        	推荐 <input name="isCommend"  type="checkbox" value="推荐" <?php if(($data["iscommend"]) == "推荐"): ?>checked<?php endif; ?> />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        	首页 <input name="ishome"  type="checkbox" value="首页" <?php if(($data["ishome"]) == "首页"): ?>checked<?php endif; ?> />
      	</div>
      </div>
      <div class="form-group">
        <div class="label">
