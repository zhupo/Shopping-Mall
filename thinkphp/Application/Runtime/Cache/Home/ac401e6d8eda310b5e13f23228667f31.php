...
<head>
    ...
    <link href="/thinkphp/Public/public_home/css/public.css" type="text/css" rel="stylesheet"/>
    <link href="/thinkphp/Public/public_home/css/index.css" type="text/css" rel="stylesheet"/>
    
    <script type="text/javascript" src="/thinkphp/Public/public_home/js/jquery-1.7.2.min.js"></script>
    <script type="text/javascript" src="/thinkphp/Public/public_home/js/slide.js"></script>
</head>
<body>
<script>
    $(function(){
...
<div class="top">
 ...
 if(isset($_SESSION['username'])) { echo "亲爱的<span style='color:#FC3;'>".$_SESSION['username']."</span>
                    欢迎光临洋店街&emsp;&emsp;<a href='/thinkphp/index.php/Home/Login/logout'>注销登录</a>"; }else{ echo "&emsp;|&emsp;请&emsp;<a href='/thinkphp/index.php/Home/Login/login' style='color: #ff9900'>登陆</a>&emsp;或&emsp;<a href='/thinkphp/index.php/Home/Login/register' style='color: #ff9900'>立即注册</a>"; } ?>
        </div>
        <div class="fr">
            <ul>
                <li style="position: relative;" id="my">
                    <a href="my_order.html">个人中心 <img src="/thinkphp/Public/public_home/image/sanjiao.png"></a>
                    <div class="personal">
                        <dl>
...
<div class="wt1080 header">
    <div class="logo fl"><a href="index.html"><img src="/thinkphp/Public/public_home/image/logo.png"></a></div>
    <div class="search fl">
        <div>
    ...
    <a class="my_shop fr" href="/thinkphp/index.php/Home/Product/sp_list/">我的购物车<span>3</span></a>
    <div class="clear"></div>
</div>
<!--------------导航------------------>
<div class="nav">
    <div class="wt1080">
        <ul>
            <li>
                <a href="/thinkphp/index.php/Home/Index/index" class="current"><span>首页</span></a>
            </li>
            <li><a href="/thinkphp/index.php/Home/Product/lanmu"><span>母婴专区</span></a></li>
...
<link href="/thinkphp/Public/public_home/css/gouwuche.css" type="text/css" rel="stylesheet"/>
<!---------------------导航完--------------------->
...
<div class="wt1080">
        ...
        <div class="goods">
        	<?php if(is_array($data)): foreach($data as $key=>$v): ?><div class="goods_details">
                  <div class="g_one"><input type="checkbox" name="ID[]" value="<?php echo ($v["id"]); ?>" /></div>
                    <div class="g_two">
                        <div class="h">
                            <div class="pic"><a href="#"><img src="/thinkphp/Public/uploads/<?php echo ($v["thumb"]); ?>"></a></div>
                            <div class="miaoshu">
                    ...
                    <div class="g_six"><a href="/thinkphp/index.php/Home/Product/shoppdel/id/<?php echo ($v["id"]); ?>"><span></span></a></div>
    ...
    <div class="hot">
        ...
        <div class="content">
            <ul>
                <li>
                    <div class="pic"><a href="#"><img src="/thinkphp/Public/public_home/image/p11.png"></a></div>
...
<div class="baozhang">
    <div class="wt1080">
        <ul>
            <li>
                <img src="/thinkphp/Public/public_home/image/c1.png">
                <p>全球正品货源</p>
            </li>
            <li>
                <img src="/thinkphp/Public/public_home/image/c2.png">
                <p>一件代发</p>
            </li>
            <li>
                <img src="/thinkphp/Public/public_home/image/c3.png">
                <p>全球直邮</p>
            </li>
            <li>
                <img src="/thinkphp/Public/public_home/image/c5.png">
                <p>售后无忧</p>
            </li>
        </ul>
        <div class="clear"></div>
...
<div class="footer">
    <div class="wt1080" style="position: relative">
        <div class="a_footer">
            <div class="left">
                <a href="index.html"><img src="/thinkphp/Public/public_home/image/logo.png"></a>
                <p class="lianxi">
                    <a href="#"><img src="/thinkphp/Public/public_home/image/weixin.png"></a>
                    <a href="#"><img src="/thinkphp/Public/public_home/image/weibo.png"></a>
                    <a href="#"><img src="/thinkphp/Public/public_home/image/QQ.png"></a>
        ...
        <div class="clear"></div>
        <div class="weixin"><img src="/thinkphp/Public/public_home/image/weixin1.png"><p>扫描二维码下载APP</p></div>
        <!------------------------>
